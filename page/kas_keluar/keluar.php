...
if(isset($_POST['cari'])){
    $tgl1 = $_POST['tgl1'];
    $tgl2 = $_POST['tgl2'];
    $tampilKas = $conn->query("SELECT * FROM tb_kas WHERE tgl BETWEEN '$tgl1' and '$tgl2' AND jenis = 'Keluar'") or die(mysqli_error($conn));
}else{
...
<div class="panel-body">
    ...
    if(isset($_POST['cari'])){
    ?>
    <a href="page/kas_keluar/print.php?tgl1=<?= $tgl1; ?>&tgl2=<?= $tgl2; ?>" onclick="return confirm('Yakin Ingin mencetak ?')" target="_blank">
